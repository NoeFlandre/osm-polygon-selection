...
COUNTRY_NOTES: dict[str, str] = {
    ...
    "sudan": (
        "Large North African country on the Red Sea (formerly "
        "Anglo-Egyptian Sudan), with most of its territory in "
        "the Sahara and Sahel. Capital Khartoum (at the "
        "confluence of the Blue and White Nile) has decent OSM "
        "coverage; the Darfur region and the eastern mountains "
        "are extremely sparsely mapped due to conflict. "
        "Geofabrik /africa/ PBF (~193 MB). Notable features "
        "include the ancient Nubian pyramids at Meroë (a "
        "UNESCO World Heritage site), the Red Sea coast with "
        "its coral reefs, and the Nile cataracts."
    ),
    "cameroon": (
        "Central African country on the Gulf of Guinea (formerly "
        "French Cameroun, then a British-French trusteeship), "
        "often called 'Africa in miniature' for its geographic "
        "and cultural diversity. Capital Yaoundé and economic "
        "capital Douala both have good OSM coverage. Geofabrik "
        "/africa/ PBF (~213 MB). Notable features include "
        "Mount Cameroon (the highest peak in West Africa at "
        "4,095 m), the Waza National Park in the north, and "
        "the Dja Faunal Reserve (a UNESCO World Heritage site)."
    ),
    "zambia": (
        "Landlocked Southern African country (formerly Northern "
        "Rhodesia) with the high plateau of the Zambezi "
        "watershed. Capital Lusaka has good OSM coverage; the "
        "Copperbelt and Victoria Falls are progressively mapped. "
        "Geofabrik /africa/ PBF (~240 MB). Notable features "
        "include Victoria Falls / Mosi-oa-Tunya (a "
        "transboundary UNESCO site shared with Zimbabwe), Lake "
        "Kariba (one of the world's largest artificial lakes), "
        "the Kafue and South Luangwa National Parks, and the "
        "Copperbelt mining region."
    ),
    "mozambique": (
        "Southeast African country on the Indian Ocean (formerly "
        "Portuguese East Africa), with a long coastline and the "
        "Zambezi River crossing the country. Capital Maputo "
        "has good OSM coverage; the northern provinces and the "
        "Zambezi Delta are sparser. Geofabrik /africa/ PBF "
        "(~243 MB). Notable features include the Bazaruto "
        "Archipelago (a marine national park), the port city "
        "of Beira, and Gorongosa National Park (a major "
        "ecotourism destination in the Rift Valley)."
    ),
    "kenya": (
        "East African country on the Indian Ocean, crossed by "
        "the equator and the Great Rift Valley. Capital "
        "Nairobi has very good OSM coverage; Mombasa on the "
        "coast and the Maasai Mara / Serengeti ecosystem are "
        "well-mapped. Geofabrik /africa/ PBF (~331 MB). "
        "Notable features include Mount Kenya (5,199 m), the "
        "Maasai Mara National Reserve (famous for the annual "
        "wildebeest migration), Amboseli and Tsavo National "
        "Parks, and the Rift Valley lakes (Naivasha, "
        "Nakuru, Bogoria)."
    ),
    "uganda": (
        "Landlocked East African country (formerly the British "
        "Protectorate of Uganda), sitting on the East African "
        "Plateau. Capital Kampala has good OSM coverage; the "
        "western Rift Valley and the source of the White Nile "
        "at Lake Victoria are progressively mapped. Geofabrik "
        "/africa/ PBF (~353 MB). Notable features include "
        "Bwindi Impenetrable National Park (home to half the "
        "world's mountain gorillas, a UNESCO World Heritage "
        "site), Murchison Falls National Park, and the "
        "Rwenzori Mountains ('Mountains of the Moon')."
    ),
    "south-africa": (
        "Large Southern African country on the Atlantic and "
        "Indian Oceans, with three capital cities: Pretoria "
        "(administrative), Cape Town (legislative), and "
        "Bloemfontein (judicial). Cape Town and Johannesburg "
        "have very good OSM coverage; Durban, Pretoria, and "
        "the Garden Route are progressively mapped. Geofabrik "
        "/africa/ PBF (~396 MB). Notable features include "
        "Table Mountain, Kruger National Park (one of Africa's "
        "largest game reserves), the Drakensberg mountains, "
        "the Cape Winelands, and Robben Island."
    ),
    "congo-democratic-republic": (
        "Large Central African country (formerly Zaire), the "
        "second-largest country in Africa, dominated by the "
        "Congo River basin and the equatorial rainforest. "
        "Capital Kinshasa (across the river from Brazzaville) "
        "has decent OSM coverage; Lubumbashi in the Katanga "
        "Copperbelt and Goma in the east are progressively "
        "mapped. Geofabrik /africa/ PBF (~393 MB). Notable "
        "features include the Virunga National Park (a "
        "UNESCO site, home to mountain gorillas), the Okapi "
        "Wildlife Reserve, and the Congo River and its "
        "tributaries."
    ),
    "nigeria": (
        "Large West African country, the most populous in "
        "Africa (formerly British Nigeria), with diverse "
        "geography from the Atlantic coast to the Sahel. "
        "Capital Abuja and economic capital Lagos both have "
        "very good OSM coverage. Geofabrik /africa/ PBF "
        "(~678 MB, the largest in /africa/). Notable features "
        "include the Niger Delta (one of the world's largest "
        "wetlands), the Jos Plateau, the Sahel regions in the "
        "north, and Yankari National Park."
    ),
}
