"""Pure filesystem layout helpers for the dataset directory.

Kept separate from the package ``__init__`` so the public
re-export list stays short and the helpers can be split further
if they grow.
"""
