...
- :func:`project_root` — the directory holding ``pyproject.toml``.
- :func:`dataset_root` — defaults to ``<project_root>/../osm-polygon-selection-dataset``,
...
__all__ = ["DATASET_ROOT_ENV", "dataset_root", "project_root"]
