...
- egypt (169 MB PBF, 24,623 polygons) — large North African country dominated by the Nile Valley; capital Cairo, the largest city in the Arab world (PBFs downloaded, not extracted)
...
- sudan (193 MB PBF, 38,043 polygons) — large North African country on the Red Sea (formerly Anglo-Egyptian Sudan); capital Khartoum at the confluence of the Blue and White Nile
- tanzania — IN QUEUE
- uganda — IN QUEUE
...
- zambia (240 MB PBF, 15,684 polygons) — landlocked Southern African country (formerly Northern Rhodesia); capital Lusaka, Victoria Falls / Mosi-oa-Tunya (UNESCO)
